...
namespace DataWallEngine
{
    ...
    extern "C" DATAWALLENGINE_API HRESULT InstallSoftware(const char* id, const char* path);
    ...
    extern "C" DATAWALLENGINE_API HRESULT CheckSoftHASH(const char* id, const char* path);
}