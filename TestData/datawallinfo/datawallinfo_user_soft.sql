...
DROP TABLE IF EXISTS `user_soft`;
...
--
-- Dumping data for table `user_soft`
--

LOCK TABLES `user_soft` WRITE;
/*!40000 ALTER TABLE `user_soft` DISABLE KEYS */;
INSERT INTO `user_soft` VALUES (1,'user',1);
/*!40000 ALTER TABLE `user_soft` ENABLE KEYS */;
UNLOCK TABLES;
